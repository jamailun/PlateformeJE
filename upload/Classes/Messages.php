...
- Pour chaque upload de fichier, le tableau "uploadAjaxServeur" est utilisé, 
...
1/ NE PAS AJOUTER DES MESSAGES AVEC DES INDEX COMMENÇANT PAR "UpAb" dans les tableaux que vous ajouterez directement (explicitement) dans vos scripts avec SetMessages, ex : new SetMessages('inscription'); dans le fichier "UploadAjaxABCI_Inscription.php".
...
abstract class Messages {
	...
	final public static function communs()
	{
		...
		, 'UpAbAllowedMemorySize'		=> "Ce fichier est trop lourd pour être traité. Réduisez votre fichier avant le téléchargement."
	...
	/* INITIALISÉ AUTOMATIQUEMENT dans la classe d'upload serveur "UploadAjaxABCIServeur" (et dans la classe "UploadFormABCIServeur" pour les scripts compatibles avec les navigateurs obsolètes)	
	 ...
	 */
	final public static function uploadAjaxServeur()
	{
		$tab = [
		  'UpAbServerFichierTemp'		=> "Fichier temporaire non valide."
		, 'UpAbServerDossierTemp'		=> "Erreur d'écriture du dossier temporaire"
	...
	*/
	final public static function redimCrop()
	{
		...
		// La ligne ci-dessous ne sert actuellement que pour les scripts utilisant "UploadFormABCIServeur.php"
		, 'UpAbImageRedimOk'				=> "Téléchargement et redimensionnement ok."	
		];		
		return $tab;
	}
	...
	// INITIALISÉ AUTOMATIQUEMENT dans la classe "UploadFormABCIServeur" en complément du tableau "uploadAjaxServeur" 	
	
	final public static function uploadFormServeur()
	{
		$tab = [
		'UpAbPostMaxSizePhpForm'		=> 'Erreur, dépassement de la taille maximale du formulaire autorisée par le serveur.'
		,'UpAbMaxFileUploadsPhpForm'	=> 'Erreur, dépassement du nombre maximal de fichiers autorisés par le serveur. Seuls les fichiers ci-dessus ont été traités.'
		,'UpAbResultOkPhpForm'			=> 'Téléchargement ok.'		
		,'UpAbChampVidePhpForm'			=> 'Champ vide.'
	    ,'UpAbMaxSizeFichierPhpForm'	=> "Dépassement de la taille maximale de fichier autorisée par le serveur."
		,'UpAbErrPartialPhpForm' 		=> "Le fichier n'a été que partiellement téléchargé."
		,'UpAbErrNoTmpDirPhpForm' 		=> "Un dossier temporaire est manquant."
		,'UpAbErrCantWritePhpForm' 		=> "Échec de l'écriture du fichier sur le disque."
		,'UpAbErrExtPhpForm' 			=> "Une extension PHP a arrêté l'envoi de fichier."
		,'UpAbdefautFatalErrorPhpForm'	=> "Echec du traitement du fichier."
		,'UpAbFatalErrorSuitePhpForm'	=> "L'erreur précédente a bloqué la poursuite du script. Fichier non traité."
		];
	...
	final public static function php_load_crop_multiple ()
	{
		...
		, 'AllowedMemorySize'			=> "Le fichier a une résolution trop grande pour être recadré. Réduisez votre fichier avant le téléchargement ou chargez-le sans effectuer de recadrage."
		];
		return $tab;		
	}
	...
	/*
	Initialisé dans les fichiers "UploadAjaxABCI_Inscription.php", "UploadAjaxABCI_Php_Load_Inscription.php" et "UploadAjaxABCI_Inscription_Photo_CompNavObs.php".
	...
	*/
	...
	/* 
	Cette fonction est appelée côté client depuis le script "UploadAjaxABCI_Inscription_Photo_Crop.php" pour afficher les messages du script javascript. 
	
	Mais elle est également appelée depuis le script "UploadAjaxABCI_Inscription_Photo_CompNavObs.php" pour construire la réponse client en complément de la fonction  "inscription()". En conséquence si vous utilisez le script "UploadAjaxABCI_Inscription_Photo_CompNavObs.php", veillez à ne pas créer de doublons d'index dans les deux fonctions "inscription()" et "inscriptionClient()"
	*/
	final public static function inscriptionClient()
	{
		$tab = [
		  'traitementTermine' 			=> "Vous êtes enregistré, traitement terminé. Vous allez être redirigé automatiquement dans les prochaines secondes, ou <a href='index.html'>cliquez ici</a>."
